...
export const workData = [
  {
    ...
    description:
      "JWT-based login system with video streaming - Node.js, PostgreSQL, Docker.",
  ...
  },
  {
    title: "Recipes Book",
    description:
      "A React-based recipe management app with real-time editing and modern UI design.",
    bgImage: "/recipesBook.png",
    technologies: [{ icon: assets.react, name: "React" }],
    link: "https://recipes-one-azure.vercel.app/",
  },
  {
    title: "Taxpal",
    description:
      "A responsive TaxPal website clone built with Next.js and React.",
    bgImage: "/taxpal.png",
    technologies: [{ icon: assets.react, name: "React" }],
  ...
  //   title: "Word Clock",
  //   description:
  //     "React world clock with multi-timezone display, theme switching, and glassmorphism design.",
...
export const internshipData = {
  ...
  workType: "Remote",
  responsibilities: [
    "Architected a robust full-stack blog system using TypeScript(Nextjs) and Nodejs, implementing a modular Controller-Service-Repository pattern and DTO-based validation to ensure 100% type safety.",
    "Optimized complex database query performance by 60% (reducing response time to 150ms) using Prisma and concurrent processing, ensuring efficient data retrieval for scalable systems.",
    "Managed reliable database schema evolution via Prisma Migrate, maintaining synchronization across development, staging, and production environments with 0% online migration failures.",
    "Collaborated in an Agile environment following Git Flow best practices, achieving a 95% PR approval rate and resolving 8+ complex merge conflicts to maintain version control integrity.",
  ],
  description:
